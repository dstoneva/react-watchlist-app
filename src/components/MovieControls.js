...
export const MovieControls = ({ type, movie }) => {
  const { removeMovieFromWatchlist, moveToWatchlist, removeFromWatched, showRatingModal } = useContext(GlobalContext);

  return (
    <div className="inner-card-controls">
      {type === "watchlist" && (
        <>
          <div className="watchlist-card-title text-center">{movie.title}</div>
